...
public class DBXWritableValue extends DBXValue {
	...
	/**
	 * @return The String value of this column.
	 */
	...
	public String getStringAssertNotNull() {
	...
	/**
	 * Checa se o valor interno e do tipo passado como argumento.
	 * @param value O tipo a ser testado.
	 * @author Vitor Bonequini.
	 */
	public boolean isTypeOf(int value)
	{
		return value == CurrentDBXType;
	}
	
	public boolean isBoolean()
	{
		return isTypeOf(DBXDataTypes.BooleanType);
	}
	
	public boolean isInteger()
	{
		return (isTypeOf(DBXDataTypes.Int8Type) || isTypeOf(DBXDataTypes.Int16Type)
				|| isTypeOf(DBXDataTypes.Int32Type) || isTypeOf(DBXDataTypes.Int64Type));
	}
	
	public boolean isDouble()
	{
		return isTypeOf(DBXDataTypes.DoubleType);
	}
	
	public boolean isString()
	{
		return (isTypeOf(DBXDataTypes.AnsiStringType) || isTypeOf(DBXDataTypes.WideStringType));
	}
